...
CLIENT_ARGS="-chardev /dev/bdr-1 -underdev /dev/mapper/bdr-1 -address 127.0.0.1 -port 9000 -noprint"
SERVER_ARGS="-target ${LOOP_DEVICES[$LOOPDEV_ID]} -port 9000 -address 127.0.0.1 -noprint"
